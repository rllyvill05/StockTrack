...
public class AddFragment extends Fragment {
    ...
    private EditText etName, etCategory, etBarcode, etQuantity, etUnitType, etBuyingPrice, etSellingPrice;
    ...
    private void saveProduct() {
        ...
        // Create product
        Product product = new Product(name, category, barcode, quantity, unitType, buyingPrice, sellingPrice);
